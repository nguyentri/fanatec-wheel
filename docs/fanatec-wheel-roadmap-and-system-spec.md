...
> ([wheel_rim.md](./wheel_rim.md), [wheel_base.md](./wheel_base.md),
> [sim_racing_research.md](./sim_racing_research.md), [repos.md](./repos.md),
> [references.md](./references.md)). It covers the full journey from a bench-only
...
### Internal
- [Brainstorm report (2026-07-03)](./260703-1808-advanced-fanatec-wheel-brainstorm.md)
...
- [Steering rim architecture](./wheel_rim.md) — §5 power rules, §8 link model, §15 bench sequence, §16 roadmap
- [Wheel-base architecture](./wheel_base.md) — safety posture and base-side context
- [Ecosystem knowledge base](./sim_racing_research.md)
- [Source register](./references.md) — source classes and currency conflicts
